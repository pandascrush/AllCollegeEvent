      ...
      <div className="nav-left">
        ...
        <button className="nav-explore">
          ...
          <span className="down-arrow" aria-hidden>
            <svg xmlns="http://www.w3.org/2000/svg" width="10" height="9" viewBox="0 0 15 9" fill="none" style={{ marginLeft: "8px", marginTop: "2px" }}>
              <path d="M1 1L6.79289 6.79289C7.18342 7.18342 7.81658 7.18342 8.20711 6.79289L14 1" stroke="#1C1C1C" strokeWidth="2" strokeLinecap="round" />
            </svg>
          </span>
        </button>
      </div>
      ...
      <div className={`nav-search-box ${open ? "nav-open" : ""}`}>
        ...
        <div className="location-icon" aria-hidden>
          <svg xmlns="http://www.w3.org/2000/svg" width="17" height="25" viewBox="0 0 20 30" fill="none">
            <path d="M0.84375 11.0004C0.8438 17.9896 7.04696 26.3384 9.22268 28.4999C9.56538 28.8403 10.0652 28.7897 10.4186 28.4603C10.4186 28.4603 18.8438 18.8688 18.8438 11.0004C18.8438 2.46075 13.2115 0.845703 9.83218 0.845703C5.88965 0.845703 0.843695 3.32739 0.84375 11.0004Z" stroke="black" strokeWidth="1.68967" />
            <circle cx="9.83534" cy="10.4193" r="4.78739" stroke="black" strokeWidth="1.68967" />
          </svg>
        </div>
      </div>
