...
function MainRoutes() {
  ...
  return (
    <Routes>
      ...
      <Route path="/signup" element={<Signup role="user" goBack={() => navigate("/login")} onSuccess={() => navigate("/login")}/>}/>
      <Route path="/login" element={<Login  role="user" onLogin={() => navigate("/")} onForgotPassword={() => navigate("/forgot-password")} onGoSignup={() => navigate("/signup")}/>}/>
      <Route path="/forgot-password" element={<ForgotPassword role="user" />} />

      {/* ------- ORGANIZER AUTH (Public) ------- */}
      <Route path="/organizer/signup" element={<Signup role="organizer" goBack={() => navigate("/organizer/login")} onSuccess={() => navigate("/organizer/login")}/>}/>
      <Route path="/organizer/login"  element={<Login  role="organizer" onLogin={() => navigate("/organizer/dashboard/home")} onForgotPassword={() => navigate("/organizer/forgot-password")} onGoSignup={() => navigate("/organizer/signup")}/>}/>
      ...
      <Route path="/organizer/dashboard" element={<DashboardLayout />}>
        ...
        <Route path="my-space/organizer-create-events" element={<CreateEvents />}/>
        <Route path="setting/notification" element={<Notification />} />
        <Route path="setting/email-setting" element={<EmailSettings />} />
        <Route path="my-profile/followers" element={<YourNetwork tab="followers" />}/>
        <Route path="my-profile/following" element={<YourNetwork tab="following" />}/>
